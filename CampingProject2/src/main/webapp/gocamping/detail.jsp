				...
				<div class="infoo">
					<hr>
						...
						<div class="infoo">
						  <script>
						    ...
						    for (var i = 0; i < etcArray.length; i++) {
						      ...
						      paragraph.innerHTML = etcArray[i];
						
						      // 생성한 <p> 태그를 div.infoo에 추가
						      document.querySelector('.infoo').appendChild(paragraph);
						    }
						  </script>
						</div>
						<br>
						...
						<!-- <style>
						  ...
						  .infoo-list li {
						    margin-bottom: 10px;
						    padding-left: 10px; /* 여백 */
						    position: relative;
						  }
						
						  .infoo-list li::before {
						    content: '-';
						    position: absolute;
						    left: 0;
						  }
						  ...
						  <ul class="infoo-list">
						    <script>
						      ...
						      for (var i = 0; i < etcArray.length; i++) {
						        ...
						        // 생성한 <li> 태그를 ul.infoo-list에 추가
						        document.querySelector('.infoo-list').appendChild(listItem);
						      }
						    </script>
						  </ul>
						</div><br> -->
